...
@st.cache_data
def load_data():
    engine = create_engine( r"mssql+pyodbc://LAPTOP-7643IQJN\SQLEXPRESS/DigitalAnalytics?driver=ODBC+Driver+17+for+SQL+Server&trusted_connection=yes"
    )
...
# === PAGE-SPECIFIC DATA FILTERING ===python -m streamlit run gg.py
...
# Merge order_items + product_name + items_purchased
        sales_data = (
                df_items_filtered
...
# Refund Amount Loss Plot ---
        ...
        va='top',
        fontsize=10,
        color='white'  # change to 'black' if your bars are light
    )
...
# Proceed only if there is data after filtering
    ...
    # Plot
            ...
            st.warning("⚠️ No orders for Product 4 available in filtered results.")
...
# Plotting
        ...
        st.markdown(
    """
    <h1 style='text-align: center; text-decoration: underline; font-weight: bold;font-size: 47px; margin-bottom: 30px;'>
